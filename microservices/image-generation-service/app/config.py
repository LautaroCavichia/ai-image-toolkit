"""
Configuration module for the image generation service.
...
CONSUME_QUEUE_NAME = os.getenv("CONSUME_QUEUE_NAME", "q_image_generation")
CONSUME_EXCHANGE_NAME = os.getenv("CONSUME_EXCHANGE_NAME", "image_processing_exchange")
CONSUME_ROUTING_KEY = os.getenv("CONSUME_ROUTING_KEY", "job.image_generation")
...
SERVICE_PORT = int(os.getenv("PORT", "8007"))
SERVICE_HOST = os.getenv("HOST", "0.0.0.0")

BASE_DIR = Path(__file__).resolve().parent.parent  # Goes up to image-generation-service/
