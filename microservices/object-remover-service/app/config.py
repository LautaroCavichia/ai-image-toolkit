"""
Configuration module for the enlarge service.
...
CONSUME_QUEUE_NAME = os.getenv("CONSUME_QUEUE_NAME", "object_remover_queue")
CONSUME_EXCHANGE_NAME = os.getenv("CONSUME_EXCHANGE_NAME", "image_processing_exchange")
CONSUME_ROUTING_KEY = os.getenv("CONSUME_ROUTING_KEY", "object.remove")
...
BASE_DIR = Path(__file__).resolve().parent.parent  # Goes up to enlarge-service/
