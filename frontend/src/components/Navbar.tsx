...
const Navbar: React.FC = () => {
  ...
  useEffect(() => {
    ...
    if (showTokenPanel || showServicesDropdown) {
  ...
  }, [showTokenPanel, showServicesDropdown]);
            ...
            <div className="relative" ref={servicesDropdownRef}>
              ...
              {showServicesDropdown && (
                <div
                  ...
                  className="absolute top-full left-0 mt-2 w-80 bg-white rounded-2xl shadow-xl border border-slate-200/50 overflow-hidden"
                >
                  <div className="p-2">
                    {[
            ...
            {isAuthenticated() && (
              <>
                ...
                <div className="border-t border-slate-200/50 pt-4 mt-4">
                  ...
                  <a 
                    href="/login" 
                    className="w-full flex items-center justify-center p-3 rounded-xl hover:bg-slate-50 text-slate-700 font-medium transition-colors duration-200"
                  >
                    Sign In
                  </a>
                </div>
